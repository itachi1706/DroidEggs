...
class NekoControlsService : ControlsProviderService(), PrefState.PrefsListener {
    ...
    private fun randomToyIcon(): Icon {
        return Icon.createWithResource(applicationContext, Cat.chooseP(rng, P_TOY_ICONS, 4))
    }
    ...
    private fun makeWaterBowlControl(fillLevel: Float): Control {
        return Control.StatefulBuilder(CONTROL_ID_WATER, getPendingIntent())
                ...
                .setCustomIcon(Icon.createWithResource(applicationContext,
    ...
    override fun performControlAction(
        ...
        when (controlId) {
            CONTROL_ID_FOOD -> {
                ...
                FirebaseLogger.histogram(this, "egg_neko_offered_food", 11)
                prefs.foodState = 11
            }
            CONTROL_ID_TOY -> {
