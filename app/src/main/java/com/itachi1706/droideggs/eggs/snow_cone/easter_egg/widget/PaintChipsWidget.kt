...
package com.itachi1706.droideggs.eggs.snow_cone.easter_egg.widget
...
val COLORS_NEUTRAL1 = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    intArrayOf(
...
val COLORS_NEUTRAL2 = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    intArrayOf(
...
var COLORS_ACCENT1 = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    intArrayOf(
...
var COLORS_ACCENT2 = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    intArrayOf(
...
var COLORS_ACCENT3 = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    intArrayOf(
...
internal fun updateAppWidget(
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
        ...
        appWidgetManager.updateAppWidget(appWidgetId, RemoteViews(allSizes.entries.first().value))
    }
}
